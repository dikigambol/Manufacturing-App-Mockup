...
import YDataWithColor from "./YDataWithColor";
                ...
                <div className="grid grid-cols-1 gap-4 pl-4 pr-4">
                    ...
                    {['bar', 'area', 'pie'].includes(sheetForm?.chart_type ?? props?.chart_type) && (
                        <>
                            ...
                            {sheetForm?.chart_type === 'bar' && (
                                <>
                                    <Label htmlFor={elementId}>Time Period</Label>
                                    <Select
                                        defaultValue={props?.time_period ?? "monthly"}
                                        onValueChange={(value) => setSheetFormValue("time_period", value)}
                                    >
                                        <SelectTrigger className="w-full">
                                    ...
                                    <div className="space-y-3">
                                        <Label>Threshold Lines (Optional)</Label>
                                        <div className="text-xs text-gray-500 mb-2">
                                            Add horizontal reference lines to show limits or targets
                                        </div>

                                        {/* Upper Threshold */}
                                        <div className="grid grid-cols-2 gap-2">
                                            <div>
                                                <Label className="text-xs">Upper Threshold</Label>
                                                <Input
                                                    type="number"
                                                    placeholder="Value"
                                                    defaultValue={props?.threshold_lines?.[0]?.value || ""}
                                                    onChange={(e) => {
                                                        const currentThresholds = props?.threshold_lines || [];
                                                        const newThresholds = [...currentThresholds];
                                                        if (newThresholds[0]) {
                                                            newThresholds[0] = { ...newThresholds[0], value: e.target.value };
                                                        } else {
                                                            newThresholds[0] = {
                                                        ...
                                                        setSheetFormValue("threshold_lines", newThresholds);
                                                    }}
                                                />
                                            </div>
                                            <div>
                                                ...
                                                <Input
                                                    type="color"
                                                    defaultValue={props?.threshold_lines?.[0]?.color || "#F44336"}
                                                    onChange={(e) => {
                                                        const currentThresholds = props?.threshold_lines || [];
                                                        const newThresholds = [...currentThresholds];
                                                        if (newThresholds[0]) {
                                                            newThresholds[0] = { ...newThresholds[0], color: e.target.value };
                                                        } else {
                                                            newThresholds[0] = {
                                                                label: "Upper Threshold",
                                                                value: "",
                                        ...
                                        <div className="grid grid-cols-2 gap-2">
                                            <div>
                                                <Label className="text-xs">Lower Threshold</Label>
                                                <Input
                                                    type="number"
                                                    placeholder="Value"
                                                    defaultValue={props?.threshold_lines?.[1]?.value || ""}
                                                    onChange={(e) => {
                                                        const currentThresholds = props?.threshold_lines || [];
                                                        const newThresholds = [...currentThresholds];
                                                        if (newThresholds[1]) {
                                                            newThresholds[1] = { ...newThresholds[1], value: e.target.value };
                                                        } else {
                                                            newThresholds[1] = {
                                            ...
                                            <div>
                                                ...
                                                <Input
                                                    type="color"
                                                    defaultValue={props?.threshold_lines?.[1]?.color || "#4CAF50"}
                                                    onChange={(e) => {
                                                        const currentThresholds = props?.threshold_lines || [];
                                                        const newThresholds = [...currentThresholds];
                                                        if (newThresholds[1]) {
                                                            newThresholds[1] = { ...newThresholds[1], color: e.target.value };
                                                        } else {
                                                            newThresholds[1] = {
                                                                label: "Lower Threshold",
                                                                value: "",
                                        ...
                                        <div className="bg-yellow-50 dark:bg-yellow-900/20 p-2 rounded text-xs text-yellow-700 dark:text-yellow-300">
                                            ...
                                            <ul className="list-disc list-inside space-y-1">
                                                <li>Leave empty to disable threshold lines</li>
                                                <li>Values should be in the same unit as your Y-axis data</li>
                                                <li>Upper threshold typically shows maximum acceptable values</li>
                                                <li>Lower threshold typically shows minimum acceptable values</li>
                                            </ul>
                                        </div>
                                    </div>
                                </>
